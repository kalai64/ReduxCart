...
function Card() {
  ...
  const handleDecrease = (id, quantity) => {
    console.log('Handling decrease:', id, quantity);
    if (quantity > 1) {
...
state.blogs.reduce((total, product) => total + product.price * (product.quantity || 1), 0)
  ...
  return <>
    <div className='bg-info text-center mb-5' style={{width:'100%',position:'sticky',top:'0',zIndex:'1',color:'black',boxShadow:'10px 10px 16px grey',borderRadius:'2em'}}>
